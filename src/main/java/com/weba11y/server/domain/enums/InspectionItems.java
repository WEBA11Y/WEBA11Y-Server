...
public enum InspectionItems {
    ...
    ALT_TEXT(0, "대체 텍스트", A, MODERATE, createTags("img", "area", "input", "object", "applet", "iframe"), "대체 텍스트가 제공되지 않았습니다."),
    ALT_MULTIMEDIA(1, "멀티미디어 대체수단", AAA, CRITICAL, createTags("video", "audio", "object"), "멀티미디어 대체수단이 제공되지 않았습니다."),
    ...
    TEXT_CONTRAST(7, "텍스트 콘텐츠의 명도 대비", A, SERIOUS, createTags("p", "span"), "텍스트와 배경 간의 명도 대비는 4.5:1 이상이어야 합니다."),
    ...
    ERROR_CORRECTION(16, "입력 오류 정정 제공", A, SERIOUS, createTags("input", "form"), "입력 오류를 정정할 수 있는 방법을 제공해야 합니다."),
    ...
    HELP_INFORMATION(19, "찾기 쉬운 도움 정보", A, MODERATE, createTags("help"), "도움 정보는 동일한 순서로 접근할 수 있어야 합니다."),
    ...
    WEB_APP_ACCESSIBILITY(23, "웹 애플리케이션 접근성 준수", A, SERIOUS, createTags("application"), "웹 애플리케이션은 접근성이 있어야 한다."),
    ...
    SCREEN_READER_COMPATIBILITY(28, "스크린 리더 호환성", A, SERIOUS, createTags("div", "span"), "스크린 리더에 대한 호환성이 필요합니다."),
    ...
    ALL_CONTENT_ACCESSIBILITY(31, "모든 콘텐츠의 접근성", A, SERIOUS, createTags("*"), "모든 콘텐츠의 접근성이 필요합니다."),
    MULTI_POINTER_INPUT(32, "단일 포인터 입력 지원", A, MODERATE, createTags("pointer"), "다중 포인터 입력은 단일 포인터 입력으로 조작할 수 있어야 합니다."),
