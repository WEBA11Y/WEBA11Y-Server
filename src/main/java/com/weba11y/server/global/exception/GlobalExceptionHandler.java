package com.weba11y.server.global.exception;

import com.weba11y.server.global.exception.custom.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleAccountLockedException(AccountLockedException e) {
